...
kwargs = {'num_workers': 24, 'pin_memory':True} if use_cuda else {'num_workers': 0}
...
# Load weights
load_weights = True
load_weights_path = '/home/annika_lundqvist144/master_thesis/OurPointPillars/pc_190415_5/parameters/epoch_0_checkpoint.pt'
if load_weights:
