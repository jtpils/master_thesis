...
def main():
    ...
    try:
        ...
        # NYTT
        print('new try:')
        myLidar.listen(lambda image: image.save_to_disk('_out/%06d' % image.frame_number))
        time.sleep(59)
        ...
        while i < 10:
            ...
            print('Current_location: %s' % location)
            time.sleep(1)
            print(carla.LidarMeasurement(carla.SensorData))

            #print(myLidar.listen(lambda lidar_data: lidar_data.__len__())




            #print('Lidar data: %s' % LidarMeasurement(myLidar.channels))
            #location.x += 40
